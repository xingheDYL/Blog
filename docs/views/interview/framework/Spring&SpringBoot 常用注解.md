---
title: Spring&SpringBoot 常用注解总结
date: 2022-10-05
category:
  - 面试准备
tag:
...
public List<Teacher> getClassRelatedTeachers(
         @PathVariable("classId") Long klassId,
...
![img](https://qiniu.xinghe.fit/Interview/@RequestBody.84a28a13.png)
...
![img](https://qiniu.xinghe.fit/Interview/c7bacd12-1c1a-4e41-aaaf-4cad840fc073.png)
