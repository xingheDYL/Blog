...
![img](http://qiniu.dyl.fit/Interview/13526879-3037b144ed09eb88.png)
...
![查看 MySQL 提供的所有存储引擎](http://qiniu.dyl.fit/Interview/image-20220510105408703.png)
...
![查看 MySQL 当前默认的存储引擎](http://qiniu.dyl.fit/Interview/image-20220510105837786.png)

如果你只想查看数据库中某个表使用的存储引擎的话，可以使用 `show table status from db_name where name='table_name'`命令。

![查看表的存储引擎](http://qiniu.dyl.fit/Interview/image-20220510110549140.png)
...
![img](http://qiniu.dyl.fit/Interview/image-20220510090309427.png)
...
![事务示意图](http://qiniu.dyl.fit/Interview/%E4%BA%8B%E5%8A%A1%E7%A4%BA%E6%84%8F%E5%9B%BE.png)
...
![数据库事务示意图](http://qiniu.dyl.fit/Interview/%E6%95%B0%E6%8D%AE%E5%BA%93%E4%BA%8B%E5%8A%A1%E7%A4%BA%E6%84%8F%E5%9B%BE.png)

另外，关系型数据库（例如：`MySQL`、`SQL Server`、`Oracle` 等）事务都有 **ACID** 特性：

![ACID](http://qiniu.dyl.fit/Interview/ACID.png)
...
![AID->C](http://qiniu.dyl.fit/Interview/AID-C.png)
...
![img](http://qiniu.dyl.fit/Interview/20210526162552353.png)
...
![img](http://qiniu.dyl.fit/Interview/image-20220511171419081.png)
